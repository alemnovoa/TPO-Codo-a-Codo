...
DATABASE = "amoblamiento.db"

#----------------------------------------------
# Conexión con la base de datos. 
# Retorna el conector (conn)
#----------------------------------------------
def conectar():
...
#----------------------------------------------
# Se crea la tabla "productos" en la
...
#----------------------------------------------
# Se da de alta un producto en la
# base de datos.
#----------------------------------------------
...
#----------------------------------------------
# Se muestran en la pantalla los datos de un  
...
#----------------------------------------------
# Se modifican los datos de un producto a partir
# de su código.
#----------------------------------------------
...
#def baja_producto(codigo):
  # try:
   ...
   # except:
       # return jsonify({'error': 'Error al dar de baja el producto'}), 500
